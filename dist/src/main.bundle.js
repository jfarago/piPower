...
var AppComponent = (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        this.piService.getAmbientTemperature().subscribe(function (res) {
            _this.ambient.temperature = Math.round((res.message.temperature * 9 / 5 + 32) * 10) / 10;
            _this.ambient.humidity = res.message.humidity;
            _this.ambient.log = res.message.log;
            _this.oldAmbientLog = _this.ambient.log;
            var tempLog = _this.ambient.log.map(function (line) { return line.temperature; });
            var humidityLog = _this.ambient.log.map(function (line) { return line.humidity; });
            _this.lineChartData[0].data = tempLog;
            _this.lineChartData[1].data = humidityLog;
            _this.lineChartLabels = new Array(tempLog.length);
        });
        setInterval(function () {
            _this.piService.getAmbientTemperature().subscribe(function (res) {
                _this.ambient.temperature = Math.round((res.message.temperature * 9 / 5 + 32) * 10) / 10;
                _this.ambient.humidity = res.message.humidity;
                _this.ambient.log = res.message.log;
                var tempLog = _this.ambient.log.map(function (line) { return line.temperature; });
                var humidityLog = _this.ambient.log.map(function (line) { return line.humidity; });
                if (_this.oldAmbientLog.length < _this.ambient.log.length) {
                    _this.oldAmbientLog = _this.ambient.log;
                    _this.lineChartData[0].data = tempLog;
                    _this.lineChartData[1].data = humidityLog;
                    _this.lineChartLabels = new Array(tempLog.length);
...
AppComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__pi_service__["a" /* PiService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__pi_service__["a" /* PiService */]) === "function" && _a || Object])
], AppComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_ngx_bootstrap_buttons__ = __webpack_require__("./node_modules/ngx-bootstrap/buttons/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_ngx_bootstrap_accordion__ = __webpack_require__("./node_modules/ngx-bootstrap/accordion/index.js");
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        ...
        providers: [
            __WEBPACK_IMPORTED_MODULE_5__pi_service__["a" /* PiService */], { provide: __WEBPACK_IMPORTED_MODULE_5__pi_service__["a" /* PiService */], useClass: __WEBPACK_IMPORTED_MODULE_5__pi_service__["a" /* PiService */] }
        ],
...
var PiService = (function () {
    ...
    PiService.prototype.getOutlets = function () {
